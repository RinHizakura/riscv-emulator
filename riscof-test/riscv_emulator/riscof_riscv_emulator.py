...
class riscv_emulator(pluginTemplate):
    __model__ = "riscv_emulator"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","riscv-emulator")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for riscv-emulator start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
    ...
    def runTests(self, testList):
      ...
      for testname in testList:
          ...
          if self.target_run:
            ...
            simcmd = self.dut_exe + ' --binary={0} --compliance={1}'.format(elf, sig_file)
          else:
            simcmd = 'echo "NO RUN"'
